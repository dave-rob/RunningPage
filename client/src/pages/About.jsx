import { Box, Heading, Text, Container, Image, Flex, Stack, Link} from "@chakra-ui/react";
...
export default function About() {
  return (
    ...
    <Stack alignSelf={"center"}>
      ...
      <Text fontSize={{base:"sm", sm:"md"}} color={"gainsboro"}>
      Running was once a big part of my life. I trained consistently and was fully invested in the sport. Over time, life shifted and my focus turned more towards weightlifting and building strength and size. Running took a back seat as priorities changed.
       <br />
       <br />
...
This site tracks my progress, miles, and races as I work toward becoming stronger, faster, and more consistent. The journey is long, but the standard is high and I’m committed to putting in the work to get there.
        ...
        <br />
        <br />
        If you’d like to support my journey toward racing all the World Marathon Majors while making a real impact, please consider donating to my Think Pink Rocks fundraiser. 
        Your contribution helps fund cutting-edge breast cancer research and promotes awareness around early detection and genetic testing. Click the Think Pink Rocks photo below to make a difference.
      </Text>
      <Link href="https://fundraisers.nyrr.org/davethinkspink" target="_blank" _focus={{outline:"none"}} display={"block"}>
            <Image src="/images/thinkpink.jpg" margin={"1rem auto 0 auto"} width={{base: "150px", sm: "250px"}}></Image>
      </Link>
    </Container>
    </>
  );
