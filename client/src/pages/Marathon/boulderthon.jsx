...
export default function Boulder({ race }) {
  const boulderRuns = [];
  ...
  groupRunsByWeek(runs).map((w) => {
    ...
    boulderRuns.push({ week: week, miles: miles });
  });
      ...
      <Container width={"100vw"}>
        <Stack spacing={6} mx={"auto"} px={10}>
          <Box width={"100"}>
            ...
            >
              {race} Marathon Training
            </Heading>
          </Box>

          <Box width="100%">
            <RunChart weeklyRuns={boulderRuns} />
          </Box>
